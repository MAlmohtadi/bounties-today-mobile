...
import {getUserCoupons} from '_actions/userCouponActions';
...
const UserCouponScreen = ({
  ...
  userCouponReducer: {coupons = [], isUserCouponLoading = true},
}) => {
  ...
  }, [navigation, userId, isUserCouponLoading]);
  return isUserCouponLoading && userId ? (
    <LoadingSpinner />
  ) : (
                ...
                <View style={styles.container}>
                  ...
                  <View style={styles.rowStyle}>
                    ...
                    <View
                      ...
                      <Text style={styles.detailsTextStyle}>{item.status}</Text>
                    </View>
                  </View>
                  <View style={styles.rowStyle}>
                    <View
